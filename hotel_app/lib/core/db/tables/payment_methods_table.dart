/// Read-only local cache of payment methods (Settings -> Payment Methods).
/// Added for the same reason as service_types_table.dart - needed so the
/// "take payment" screen has a method picker while offline.
class PaymentMethodsTable {
  PaymentMethodsTable._();

  static const String tableName = 'payment_methods';
